...
$sql = "SELECT * FROM consultant_registration WHERE status = 'approved' ORDER BY id DESC";
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">All Consultants List</h4>
                        <ol class="breadcrumb">
                            <li>
                                <a href="index.php">Dashboard</a>
                            </li>
                            <li>
                                <a href="all_consultants.php">All Consultants</a>
                            </li>
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                             <h4 class="m-t-0 header-title"><b>Approved Consultants</b></h4><br>
