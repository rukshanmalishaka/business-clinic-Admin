                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="pending_consultants.php" class="waves-effect"><i class="ti-time"></i> <span> Pending <?php if ($pendingCount > 0): ?> <span class="badge badge-xs badge-danger"><?php echo $pendingCount; ?></span><?php endif; ?></span></a>
                            ...
                            <li class="has_sub">
                                <a href="admin_logout.php" class="waves-effect"><i class="ti-power-off"></i><span>Logout</span></a>
