...
$sql = "SELECT * FROM consultant_registration WHERE status = 'suggested' ORDER BY id DESC";
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Suggested Consultants List</h4>
                        <ol class="breadcrumb">
                            <li>
                                <a href="index.php">Dashboard</a>
                            </li>
                            <li>
                                <a href="pending_consultants.php">Suggested Consultants</a>
                            </li>
                            <li class="active">
                                All Suggested Consultants
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                             <h4 class="m-t-0 header-title"><b>All Suggested Consultants</b></h4><br>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td><span class='label label-inverse'>" . $row['status'] . "</span></td>";
                                        ...
                                        echo "<td>
                                              <div style='display: inline-block;'>
                                                    <form action='approve_consultant.php' method='post'>
                                                        ...
                                                        <input class='btn btn-primary' type='submit' value='Approve' onclick='return confirmApprove();'>
                                                    </form>
                                                </div>
                                                <div style='display: inline-block;'>
