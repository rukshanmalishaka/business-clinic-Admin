...
// Count the number of pending consultants
    $sqlPending = "SELECT COUNT(*) AS pendinga_count FROM consultant_registration WHERE status = 'pending'";
    $resultPending = $conn->query($sqlPending);
    $PendingACount = $resultPending->fetch_assoc()['pendinga_count'];
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="card-box widget-box-1 bg-white">
                                	...
                                	<h4 class="text-dark">Pending Consultants</h4>
                                	<h2 class="text-primary text-center"><span data-plugin="counterup"><?php echo $PendingACount; ?></span></h2>
                                	<p class="text-muted">Still Not Suggested by Admin's</p>
                                </div>
                            </div>
