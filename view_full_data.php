                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-8">
                                  ...
                                  <center>
                                      <a class="btn btn-default" href="<?php echo $row['cv1']; ?>" target="_blank">View CV</a>
                                      <a class="btn btn-inverse" href="<?php echo $row['cv1']; ?>" download>Download CV</a>
                                  </center><br>
                                   ...
                                   <?php
                                        ...
                                        if ($row['status'] == 'approved') {
                                            ...
                                            <form action="approve_consultant.php" method="post">
                                                <input type="hidden" name="consultant_id" value="<?php echo $row['id']; ?>">
                                                <input class="btn btn-primary" type="submit" value="Suggest Consultant" onclick="return confirmApprove();">
                                            </form>
                                            <?php
                                        } else {
